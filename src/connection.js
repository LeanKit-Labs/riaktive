...
function connect( options ) {
	...
	var operations = [ 'getBuckets', 'getBucket', 'setBucket', 'resetBucket', 'put', 'get', 'del', 
		...
		'updateDtype', 'fetchDtype', 'ykGetIndex', 'ykPutIndex', 'ykDeleteIndex', 'ykPutSchema',
		'ykGetSchema', 'getKeys', 'getIndex' ];
...
function lift( client ) { // jshint ignore:line
	var lifted = {
		...
		ykGetIndex: nodeWhen.lift( client.ykGetIndex ).bind( client ),
		ykPutIndex: nodeWhen.lift( client.ykPutIndex ).bind( client ),
		ykDeleteIndex: nodeWhen.lift( client.ykDeleteIndex ).bind( client ),
		ykPutSchema: nodeWhen.lift( client.ykPutSchema ).bind( client ),
		ykGetSchema: safeLift( client.ykGetSchema.bind( client ) ),
